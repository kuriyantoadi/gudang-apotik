      ...
      <div class="col-lg-12 col-xs-12">
        <div class="alert alert-info alert-dismissable">
          ...
          <p style="font-size:15px">
            <i class="icon fa fa-user"></i> Selamat datang <strong><?php echo $_SESSION['nama_user']; ?></strong> di Sistem Informasi Manajemen Gudang Instalasi Farmasi RS Kencana.
          <br><h2>RS Kencana | Jl. Jenderal A.Yani No. 21-23 Serang</h2>
		  </p>        
        </div>
      </div>
    </div>
