...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
	...
	if ($_GET["module"]=="beranda") { ?>
		<li class="active">
			<a href="?module=beranda"><i class="fa fa-home"></i> Beranda(test) </a>
	  	</li>
	<?php
	}
  ...
  // jika tidak, menu data obat tidak aktif
    ...
    <li>
      <a href="?module=obat"><i class="fa fa-folder"></i> Data Obat (test)</a>
      </li>
  <?php
  }
  ...
  if ($_GET["module"]=="obat_masuk" || $_GET["module"]=="form_obat_masuk") { ?>
    <li class="active">
      <a href="?module=obat_masuk"><i class="fa fa-clone"></i> Data Obat Masuk (test) </a>
      </li>
  <?php
  }
...
elseif ($_SESSION['hak_akses']=='Manajer') { ?>
  ...
  if ($_GET["module"]=="lap_stok") { ?>
    <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="?module=lap_stok"><i class="fa fa-circle-o"></i> Stok Obat </a></li>
            <li><a href="?module=lap_obat_masuk"><i class="fa fa-circle-o"></i> Obat Masuk (test)</a></li>
          </ul>
      </li>
    <?php
  }
