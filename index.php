...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | SISTEM INFORMASI MANAJEMEN GUDANG INSTALASI FARMASI RUMAH SAKIT KENCANA</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="SISTEM INFORMASI MANAJEMEN GUDANG INSTALASI FARMASI RUMAH SAKIT KENCANA">
    <meta name="author" content="Mochammad Effendy" />

    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/logo-rs.png" />
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo-rs.png" alt="Logo" height="150">
		<br><center><p><b>SIMGUD IFRS KENCANA</a></p></center></b>
      </div><!-- /.login-logo -->
      <?php  
