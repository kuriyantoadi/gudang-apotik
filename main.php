...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | SISTEM INFORMASI MANAJEMEN GUDANG INSTALASI FARMASI RUMAH SAKIT KENCANA</title>
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <img style="margin-top:-12px" src="assets/img/logo-rs.png" alt="Logo" height="50">
